...
RUN comfy model download --url https://huggingface.co/numz/SeedVR2_comfyUI/blob/main/seedvr2_ema_7b_fp16.safetensors --relative-path models/diffusion_models --filename seedvr2_ema_7b_fp16.safetensors
